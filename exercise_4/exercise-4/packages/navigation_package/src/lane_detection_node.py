...
class LaneDetectionNode(DTROS):
    ...
    def callback(self, msg):
        ...
        cv2.putText(overlay, self.state, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    def compute_lane_center(self, mask_yellow, mask_white, image_width):
        ...
        if yel_x_mean is not None and whi_x_mean is not None:
            ...
            #if self.state == "pid_follow_in_opposite_lane":
            lane_center = 350  # 300 is too much # turning right 
        elif whi_x_mean is not None:
            lane_center = whi_x_mean + 35 
        else:
